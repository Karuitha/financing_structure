...
my_data %>% 
  ...
  ggplot(aes(x = fct_reorder(age, capital_asset_ratio, median), y = (capital_asset_ratio + 1), fill = age)) + 
...
(my_data %>% 
   ...
   mutate(deposits_to_total_assets = deposits_to_total_assets + 1) %>% 
  
  
  ggplot(aes(x = fct_reorder(age, deposits_to_total_assets, median), 
  ...
  coord_trans(y = "log10") + 
   ...
   labs(x = "Age", y = "Deposits to Total Assets Ratio", 
        
        title = "Deposits to Total Assets Ratios of MFIs by Age") + 
   
   
   my_data %>% 
  
  filter(donations_assets_ratio >= 0) %>% 
  
  ggplot(aes(x = fct_reorder(age, donations_assets_ratio, median), 
             
             y = donations_assets_ratio + 1, fill = age)) + 
  ...
  coord_trans(y = "log10") + 
   ...
   labs(x = "Age", y = "Donations to Assets Ratio", 
        
        title = "Donations to Assets Ration by MFI Age")) 
...
stargazer(fixed_effects_dona, fixed_effects_dona3, 
         ...
         pooling_dona, title = "Regression Output for Deposits to Assets Ratio", 

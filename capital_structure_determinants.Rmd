...
fixed_effects_depo <- modelling(data = my_data, depvar = log(my_data$deposits_to_total_assets + 1))

fixed_effects_depo <- modelling(data = data3, depvar = log(data3$deposits_to_total_assets + 1))

fixed_effects_depo <- modelling(data = data5, depvar = log(data5$deposits_to_total_assets + 1))

random_effects_depo <- modelling(data = my_data, depvar = log(my_data$deposits_to_total_assets + 1), model = "random")

random_effects_depo <- modelling(data = data3, depvar = log(data3$deposits_to_total_assets + 1), model = "random")

random_effects_depo <- modelling(data = data5, depvar = log(data5$deposits_to_total_assets + 1), model = "random")
